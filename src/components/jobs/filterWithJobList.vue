                    ...
                    <div class="jobs-filter-item">
                        ...
                        <div class="jobs-filter-c">
                            <el-checkbox-group
                                    ...
                                    :max="1"
                                    v-model="datePostedValue"
                            >
                                <el-checkbox :label="7">
                                    <template #default>7 days</template>
                                </el-checkbox>
                            </el-checkbox-group>
...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            let datePostedArr = this.datePostedValue
            if(datePostedArr && datePostedArr.length){
                let datePostedNumber = datePostedArr[0]
                let nowDate = new Date()
                nowDate.setDate(nowDate.getDate() - datePostedNumber)
        ...
        datePostedChange() {
            console.log(this.datePostedValue)
            this.search()
        }
