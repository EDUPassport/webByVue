            ...
            <el-tabs type="border-card">
              <el-tab-pane label="Login">
                <el-row class="marginTop container-7" justify="center" align="middle">
                  <el-col :xs="24" :sm="24" :md="20" :lg="20" :xl="15">
                    <el-form
                        :model="ruleForm"
                        :rules="rules"
                        ref="ruleForm"
                    ...
                    >
                      <el-form-item prop="email">
                        <el-input class="elInput" placeholder="Username/Email" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item prop="password">
                        <el-input placeholder="Password" type="password" v-model="ruleForm.password"></el-input>
                      </el-form-item>
                      <el-form-item>
                ...
                <el-row class=" marginTop container-5" justify="center" align="middle">
                  <el-col :xs="22" :sm="20" :md="20" :lg="20" :xl="15">
                    <el-button class="apple-btn" plain icon="iconfont  el-icon-aliapple">Sign in with Facebook</el-button>
                  </el-col>
                </el-row>
              ...
              <el-tab-pane label="Register">
                ...
                <el-row class="marginTop container-3" justify="center" align="middle">
                  <el-col :xs="22" :sm="20" :md="20" :lg="20" :xl="15">
                    ...
                    >
                      <el-form-item  prop="email">
                        <el-input placeholder="First Name" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item  prop="email">
                        <el-input placeholder="Last Name" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item  prop="email">
                        <el-input placeholder="Email" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item  prop="email">
                        <el-input placeholder="Email Activation Code" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item  prop="email">
                        <el-input placeholder="Password" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <el-form-item  prop="email">
                        <el-input placeholder="Confirm Password" v-model="ruleForm.email"></el-input>
                      </el-form-item>
                      <div class="identity-container">
                        <div class="identity-label">I am a/an</div>
                        <div class="identity-content">
                          <el-button>Educator</el-button>
                          <el-button>Business</el-button>
                          <el-button>Vendor</el-button>
                        </div>
                      </div>
                      <el-form-item>
                        <el-button class="submit-btn" :loading="submitLoadingStatus" @click="submitForm('ruleForm')">
                ...
                <el-row class="marginTop container-6" justify="center" align="middle">
                  <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="15">
                    <el-button class="apple-btn" plain icon="iconfont  el-icon-aliapple">Sign in with Facebook</el-button>
                  </el-col>
                </el-row>
                <el-row class=" marginTop container-5" justify="center" align="middle">
