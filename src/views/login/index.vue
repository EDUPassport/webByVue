<template>
    <div class="login-bg">
        ...
        <el-dialog v-model="signUpDialogVisible" :width="signUpDialogWidthValue">
            <div class="sign-up-dialog-container">
                <div class="sign-up-dialog-img-container">
                    <el-image class="sign-up-dialog-img" :src="logoImgLight"></el-image>
                </div>
                <div class="sign-up-dialog-label">
                    New User
                </div>
                <div class="sign-up-dialog-tips">
                    Oops... Looks like you don't have an account with us
                </div>
                <div class="sign-up-dialog-btn-container">
                    <GoogleLogin style="width: 100%;"
                                 class="login-option-btn"
                                 :callback="googleSignInWithCodeFromDialog">
                        <el-button size="large"
                                   :loading="submitLoginGoogleLoadingStatusFromDialog"
                                   plain style="width: 100%;">
                            <template #icon>
                                <el-icon>
                                    <IconLogosGoogleIcon></IconLogosGoogleIcon>
...
export default {
    ...
    setup(props, context) {
        ...
        const submitLoginGoogleLoadingStatusFromDialog = ref(false)
        ...
        const signUpDialogWidthValue = ref('500px')
        ...
        function googleSignInWithCode(response) {
            ...
            GOOGLE_CALLBACK_LOGIN(params).then(res => {
                // console.log(res)
                if (res.code === 200) {
        ...
        function googleSignInWithCodeFromDialog(response) {

            submitLoginGoogleLoadingStatusFromDialog.value = true;
            ...
            router.push({
                path: '/signup',
                query: {method: encodeByJsBase64(JSON.stringify(routeQuery))}
            })
        ...
        onMounted(() => {
            ...
            if (screenWidthFloor <= 768) {
                ...
                signUpDialogWidthValue.value = '90%'
            }
        ...
        return {
            ...
            submitLoginGoogleLoadingStatusFromDialog,
            identityValue,
            ...
            googleSignInWithCodeFromDialog,
