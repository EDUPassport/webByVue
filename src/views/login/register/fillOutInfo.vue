        ...
        <div class="signup-m">
          ...
          <template v-if="userType === 'educator'">
            ...
            <div class="signup-m-form">
              ...
              <el-form :model="educatorForm" :rules="educatorRules" ref="educatorForms" @submit.prevent
                label-width="100px" label-position="top" class="demo-ruleForm">
                <el-form-item label="First Name" prop="first_name">
                  <el-input placeholder="Enter your First Name" :formatter="(value) => validForbid(value)"
                    :parser="(value) => value.replace(/[^\u4E00-\u9FA5a-zA-Z0-9]/g, '')" @keyup.enter="continueNextStep()"
                    v-model="educatorForm.first_name">
                  </el-input>
                </el-form-item>
                <el-form-item label="Last Name" prop="last_name">
                  <el-input placeholder="Enter your Last Name" :formatter="(value) => validForbid(value)"
                    :parser="(value) => value.replace(/[^\u4E00-\u9FA5a-zA-Z0-9]/g, '')" @keyup.enter="continueNextStep()"
                    v-model="educatorForm.last_name">
                  </el-input>
                </el-form-item>
                <el-form-item label="Current Residence" prop="current_residence">
                  <el-input placeholder="Enter your Residence" @keyup.enter="continueNextStep()"
                    v-model="educatorForm.current_residence">
                  </el-input>
                </el-form-item>

                <el-form-item label="Nationality" prop="nationality">
                  <el-select v-model="educatorForm.nationality" style="width: 100%;" filterable fit-input-width
                    :teleported="false" placeholder="Select your Nationality">
                ...
                <div class="continue-btn-container">
                  <el-button class="continue-btn" size="large" type="primary" :loading="continueLoadingStatus"
          ...
          <template v-if="userType === 'school'">
            ...
            <div class="signup-m-form">
              ...
              <el-form :model="schoolForm" :rules="schoolRules" ref="schoolForms" @submit.prevent label-width="100px"
                label-position="top" class="demo-ruleForm">
                <el-form-item label="Country" prop="country_id">
                  <el-select v-model="schoolForm.country_id" style="width: 100%;" :teleported="false"
                    @change="countryChange(schoolForm.country_id)" value-key="id" filterable
                    placeholder="Select your Country">
                    <el-option v-for="(item, i) in countryOptions" :key="i" :label="item.name" :value="item.id">
                    </el-option>
                  </el-select>
                ...
                <template v-if="stateOptions.length > 0">
                  <el-form-item label="Province" prop="state_id">
                    <el-select v-model="schoolForm.state_id" style="width: 100%;" :teleported="false" value-key="id"
                      filterable @change="stateChange(schoolForm.country_id, schoolForm.state_id)"
                      placeholder="Select your province">
                      <el-option v-for="(item, i) in stateOptions" :key="i" :label="item.name" :value="item.id">
                      </el-option>
                    </el-select>
                  </el-form-item>
                </template>
                ...
                <template v-if="townOptions.length > 0">
                  <el-form-item label="City" prop="town_id">
                    <el-select v-model="schoolForm.town_id" style="width: 100%;" :teleported="false" value-key="id"
                      filterable @change="townChange" placeholder="Select your city">
                      <el-option v-for="(item, i) in townOptions" :key="i" :label="item.name" :value="item.id">
                      </el-option>
                    </el-select>
                  </el-form-item>
                </template>
                ...
                <el-form-item label="School Name" prop="company_name">
                  <el-input placeholder="Enter your School Name" @keyup.enter="continueNextStep()"
          ...
          <template v-if="userType === 'recruiter'">
            ...
            <div class="signup-m-form">
              ...
              <el-form :model="recruiterForm" :rules="recruiterRules" ref="recruiterForms" @submit.prevent
                label-width="100px" label-position="top" class="demo-ruleForm">
                <el-form-item label="Company Name" prop="company_name">
                  <el-input placeholder="Enter your Company Name" @keyup.enter="continueNextStep()"
                    v-model="recruiterForm.company_name">
                  </el-input>
                </el-form-item>

                <el-form-item label="Country" prop="country_id">
                  <el-select v-model="recruiterForm.country_id" style="width: 100%;" :teleported="false" value-key="id"
                    filterable placeholder="Select your Country">
                    <el-option v-for="(item, i) in countryOptions" :key="i" :label="item.name" :value="item.id">
                    </el-option>
                  </el-select>
          ...
          <template v-if="userType === 'other'">
            ...
            <div class="signup-m-form">
              ...
              <el-form :model="otherForm" :rules="otherRules" ref="otherForms" @submit.prevent label-width="100px"
                label-position="top" class="demo-ruleForm">
                <el-form-item label="Company Name" prop="company_name">
                  <el-input placeholder="Enter your Company Name" @keyup.enter="continueNextStep()"
          ...
          <template v-if="userType === 'vendor'">
            ...
            <div class="signup-m-form">
              ...
              <el-form :model="vendorForm" :rules="vendorRules" ref="vendorForms" @submit.prevent label-width="100px"
                label-position="top" class="demo-ruleForm">
                <el-form-item label="Business Name" prop="company_name">
                  <el-input placeholder="Enter your Business Name" @keyup.enter="continueNextStep()"
...
export default {
  ...
  computed: {
    educatorForm: {
      get() {
        return this.$store.state.SignUpForm.educatorForm;
      },
      set(val) {
        this.$store.commit('SignUpForm/setValues', val);
      }
    },
    ...
    schoolForm: {
      ...
      get() {
        return this.$store.state.SignUpForm.schoolForm;
      },
      set(val) {
        this.$store.commit('SignUpForm/setSchoolValues', val);
      }
    },

    recruiterForm: {
      get() {
        return this.$store.state.SignUpForm.recuiterForm;
      },
      set(val) {
        this.$store.commit('SignUpForm/setRecuiterValues', val);
      }
    },

    otherForm: {
      get() {
        return this.$store.state.SignUpForm.otherForm;
      },
      set(val) {
        this.$store.commit('SignUpForm/setOtherValues', val);
      }
    },

    vendorForm: {
      get() {
        return this.$store.state.SignUpForm.vendorForm;
      },
      set(val) {
        this.$store.commit('SignUpForm/setVendorValues', val);
      }
    },
    ...
    function continueNextStep() {
      ...
      forms.validate((valid) => {
        if (valid) {
          ...
          router.push({ path: '/signup/accountCreation', query: { type: userType,} })
