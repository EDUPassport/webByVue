        ...
        <div class="conversation-list">
                                    ...
                                    <div class="conversation-bottom">
                                        <div class="conversation-content" v-if="conversation.lastMessage.recalled">
                                            <div v-if="conversation.type === 'private'">
                                                {{
                                                conversation.lastMessage.senderId === currentUser.uuid ? 'you' : `"${conversation.data.name}"`
                                                }} retracted a message
                                            </div>
                                            <div v-if="conversation.type === 'group'">
                                                {{
                                                conversation.lastMessage.senderId === currentUser.uuid ? 'you' : `"${conversation.lastMessage.senderData.name}"`
                                                }} retracted a message
                                            </div>
                                        </div>
                                        <div class="conversation-content" v-else>
                                            ...
                                            <span class="text"
                                                  v-if="conversation.lastMessage.type === 'text'">{{ conversation.lastMessage.payload.text }}</span>
            ...
            <div v-if="rightClickMenu.visible"
                ...
                <div class="action-item" @click="topConversation">
                    {{ rightClickMenu.conversation.top ? 'UNPIN' : 'PIN CHAT TO THE TOP' }}
                </div>
