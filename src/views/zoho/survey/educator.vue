<template>
    <div class="bg">
        <div class="form-container">
            <h2 class="form-label">Educator Survey</h2>
            ...
            <el-form
                ...
                ref="vForms"
            >
                <el-form-item prop="Radio"  label="Were you able to land a job opportunity through the platform?">
                ...
                <template v-if="typeValue === 'No'">
                    <el-form-item prop="MultiLine" label="Are there any obstacles that you might be facing in the hiring process? " >
