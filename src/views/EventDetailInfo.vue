<template>
  <div>
    <el-dialog :model-value="mapDialogLoading" width="auto" center :show-close="false" :before-close="beforeClose">
    ...
    <el-dialog v-model="mapDialogVisible" width="auto" center :show-close="false" :before-close="beforeMapDialogClose">
...
import { EVENT_DETAIL } from "@/api/api";
export default {
