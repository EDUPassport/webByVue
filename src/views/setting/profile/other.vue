                        ...
                        <div class="profile-form">
                            ...
                            >
                                ...
                                <el-form-item  label="Technology Available" prop="technology_available">
                                    <el-input v-model="professionForm.technology_available"
                                              class="form-width-388"
                                              :disabled="stepTwoStatus"
                                              type="textarea"
                                              :rows="4"
                                ...
                                <el-form-item  label="Field Trips">
                                    <el-switch :disabled="stepTwoStatus" v-model="professionForm.felds_trips"></el-switch>
                                </el-form-item>
...
import {
    ADD_USER_IMG_V2,
    GET_COUNTRY_LIST, OTHER_COMPANY_EDIT_V2,
    SWITCH_IDENTITY_V2,
    UPLOAD_BY_ALI_OSS,
    UPLOAD_BY_SERVICE,
            ...
            OTHER_COMPANY_EDIT_V2(params).then(res => {
                if (res.code === 200) {
                    ...
                    if (profileAction.value === 'add') {
                        companyId.value = res.message.other_company_id
                        changeIdentity(res.message.other_company_id, 2)
        ...
        if (valid) {
            ...
            OTHER_COMPANY_EDIT_V2(params).then(res => {
                if (res.code === 200) {
                    ...
                    if (profileAction.value === 'add') {
                        companyId.value = res.message.other_company_id
                        changeIdentity(res.message.other_company_id, res.message.user_id, 2)
...
const changeIdentity = (companyId, language) => {
    ...
    SWITCH_IDENTITY_V2(params).then(res => {
        ...
        if (res.code == 200) {
            ...
            history.pushState({}, '', '/setting/profile/other')
