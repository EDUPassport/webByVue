...
const routes = [
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "noFound" */ "@/views/zoho/survey/educator.vue"
                ),
        meta: {
            titleC: "Educators",
            titleG: "Educators",
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "noFound" */ "@/views/zoho/survey/business.vue"
                ),
        meta: {
    ...
    },
    {
        ...
        name: "fromAdminPanel",
        component: () =>
            import(/* webpackChunkName: "noFound" */ "@/views/fromAdminPanel.vue"),
        meta: {
    ...
    },
    {
        ...
        component: () =>
            import(
                /* webpackChunkName: "noFound" */ "@/views/deleteAccountSuccess.vue"
                ),
        meta: {
