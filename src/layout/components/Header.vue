                                                ...
                                                <el-popover :width="160">
                                                    ...
                                                    <template #default>
                                                        ...
                                                        <div class="user-container-1-earth-expand">
                                                            <div class="user-container-1-earth-international"
                                                                 @click="goInternationalWebsite()">
                                                                <span v-if="envName === 'development' || envName === 'production'"></span>
                                                                International
                                                            </div>
                                                            <div class="user-container-1-earth-china"
                                                                 @click="goChinaWebsite()">
                                                                ...
                                                                <div class="notification-items"
                                                                    ...
                                                                    >
                                                                        <div class="notification-survey-l">
                                                                            <el-image class="notification-survey-icon"
                                                                                      :src="notificationSurveyIcon"></el-image>
                                                                        </div>
                                                                        <div class="notification-survey-r">
                                                                            <p>Hey there! How was your experience using
                                                                                our app for hiring? Let us know by
                                                                                filling out a quick form. We value your
                                                                                feedback.
                                                                            </p>
                                                                    ...
                                                                    <div class="notification-item"
                                                                         v-for="(item,i) in inAppNotificationData"
                                                                         :key="i"
                                                                    >
                                  ...
                                  <span class="el-dropdown-link-sp">
                                     Vendor
                                                                        ...
                                                                        <template #dropdown>
                                                                            <el-dropdown-menu>
                                                                                <template
                                                                                        v-if="vendorCompanyData.length>0">
                                    ...
                                    <div class="user-avatar">
                                        <el-avatar class="user-avatar-img"
                                                   :src="userAvatar !='' ? userAvatar : defaultAvatar"></el-avatar>
                                    </div>
...
import notificationSurveyIcon from '@/assets/newHome/notification-survey.png'
...
.notification-survey-icon{
    width: 30px;

}
.notification-survey-r {
    width: calc(100% - 50px);
    text-align: right;
}

.notification-survey-r p {
    font-family: AssiRegular, Open Sans, Helvetica Neue, Arial, Helvetica, sans-serif;
    font-size: 18px;
